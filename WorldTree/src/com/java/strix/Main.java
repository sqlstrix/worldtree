...
public class Main {
	...
	public static void main(String[] args) { // новый комментарий
		...
		String aString = "на уровне √рунтј";
		System.out.println(Formatter.makePrettyLookingString("э“о".concat(" ").concat(aString)));
		System.out.println(Formatter.makePrettyLookingString("Ёто отформатированна€ строка!", "-%s - %d!"));
